...
def test_dca(coll):
    main(
        ...
        stop_losses=[[8, 8]],
        leverages=[[1, 1]],
        dcas=[[[[0, 50]], [[0, 50]]], [[[0.5, 50]], [[0.5, 50]]], [[[1, 50]], [[1, 50]]], [[[7, 50]], [[7, 50]]]],
        multiproc=False,
        enable_qol=False,
        winrate_floor=0,
        mean_floor=-10,
...
def test_with_invalid_sl_leverage_config(coll):
    main(
        db_coll=c.COLL,
...
def test_multi_dca(coll):
    ...
    main(
        ...
        stop_losses=[[6, 4, 2]],
        leverages=[[4, 2, 1]],
        dcas=[[[[2, 33], [4, 34]], [[2, 50]], [[0.25, 25], [0.5, 25], [0.75, 25]]]],
        multiproc=False,
        enable_qol=False,
        winrate_floor=0,
        mean_floor=-10,
...
def test_with_one_trade_and_multiple_configs(coll):
    main(
        db_coll=c.COLL,
        datafilenames=["test_data/BYBITBTCUSD_240_2021_one_trade.csv"],
        take_profits=[[0.5], [2]],
...
def test_with_scenario_that_covers_signal_exits_in_profit(coll):
    main(
        db_coll=c.COLL,
        datafilenames=["test_data/BYBITBTCUSD_240_2021_five_trades.csv"],
        take_profits=[[1000]],
...
def test_with_three_trades(coll):
    main(
        db_coll=c.COLL,
        datafilenames=["test_data/BYBITBTCUSD_240_2021_three_trades.csv"],
        take_profits=[[4]],
